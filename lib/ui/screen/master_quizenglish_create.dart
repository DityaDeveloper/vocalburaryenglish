...
class MasterQuizHiraCreate extends StatefulWidget {
  const MasterQuizHiraCreate({Key? key, this.documentSnapshot})
      : super(key: key);
  final DocumentSnapshot? documentSnapshot;
  @override
  State<MasterQuizHiraCreate> createState() => _MasterQuizHiraCreateState();
}

class _MasterQuizHiraCreateState extends State<MasterQuizHiraCreate> {
