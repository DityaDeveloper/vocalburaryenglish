...
import 'master_quizindonesia_create.dart';

class MasterQuizKanaScreen extends StatefulWidget {
  const MasterQuizKanaScreen({Key? key}) : super(key: key);

  @override
  State<MasterQuizKanaScreen> createState() => _MasterQuizKanaScreenState();
}

class _MasterQuizKanaScreenState extends State<MasterQuizKanaScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Master Kuis Bahasa Indonesia',
                      ...
                      children: [
                        Row(
                          children: [
                            const Text("Jawaban : "),
                            Text(
                              documentSnapshot['option1'].toString(),
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => const MasterQuizKanaCreate()),
          );
        },
